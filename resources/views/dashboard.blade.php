...
@section('content')
    <div id="admin-content">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h2 class="admin-heading">Panel</h2>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="card" style="width: 14rem; margin: 0 auto;">
                        <div class="card-body text-center">
                            ...
                            <h5 class="card-title mb-0">Lista de editoriales</h5>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="card" style="width: 14rem; margin: 0 auto;">
                        <div class="card-body text-center">
                            ...
                            <h5 class="card-title mb-0">Registrar Estudiantes</h5>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card" style="width: 14rem; margin: 0 auto;">
                        <div class="card-body text-center">
                            ...
                            <h5 class="card-title mb-0">Libros Emitidos</h5>
                        </div>
                    </div>
                </div>
            </div>

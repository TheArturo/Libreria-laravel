    ...
    <div class="container">
        <div class="row">
            ...
            <div class="offset-md-7 col-md-2">
              <a class="add-new" href="{{ route('publishers') }}">Todos los Editoriales</a>
            </div>
        </div>
        <div class="row">
            <div class="offset-md-3 col-md-6">
                <form class="yourform" action="{{ route('publisher.store') }}" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('name') isinvalid @enderror" placeholder="Nombre de Editorial" name="name" value="{{ old('name') }}" required>
                        @error('name')
